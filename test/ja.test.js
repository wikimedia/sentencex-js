...
const tests = {
  ...
  'アンディ・ガトマンズ（英: Andi Gutmans、ヘブライ語: はスイスにルーツを持つイスラエル人プログラマで、PHPの開発とゼンド・テクノロジーズの創業者の1人として知られている。ハイファにあるイスラエル工科大学出身で、1997年に友人のゼーブ・スラスキーと共に PHP 3 を開発した。1999年、PHP 4 の中核である Zend Engine を開発し、ゼンド・テクノロジーズを創業。その後PHPの発展に関与し続け、PHP 5 開発にも参加している。なおZendという名称は、ガトマンズとスラスキーの名前（ZeevとAndi）を組み合わせたかばん語である。':
    [
      'アンディ・ガトマンズ（英: Andi Gutmans、ヘブライ語: אנדי גוטמנס‎）はスイスにルーツを持つイスラエル人プログラマで、PHPの開発とゼンド・テクノロジーズの創業者の1人として知られている[1]。',
      'ハイファにあるイスラエル工科大学出身で、1997年に友人のゼーブ・スラスキーと共にPHP 3を開発した。1999年、PHP 4の中核である Zend Engine を開発し、ゼンド・テクノロジーズを創業。',
      'その後PHPの発展に関与し続け、PHP 5開発にも参加している[2]。',
...
describe('Japanese segment()', function () {
  for (const [text, expectedSentences] of Object.entries(tests)) {
    it(`correctly segments text: ${text}`, function () {
      const sentences = segment('ja', text)
