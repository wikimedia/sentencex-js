...
const tests = {
  ...
  'Sie erhalten ein neues Bank-Statement bzw. ein neues Schreiben.': ['Sie erhalten ein neues Bank-Statement bzw. ein neues Schreiben.'],
  ...
  'Wir benötigen Zeitungen, Zeitschriften u. Ä. für unser Projekt.': ['Wir benötigen Zeitungen, Zeitschriften u. Ä. für unser Projekt.'],

  'Das steht auf S. 23, s. vorherige Anmerkung.': ['Das steht auf S. 23, s. vorherige Anmerkung.'],

  'Dies ist meine Adresse: Dr. Meier, Berliner Str. 5, 21234 Bremen.': ['Dies ist meine Adresse: Dr. Meier, Berliner Str. 5, 21234 Bremen.'],
